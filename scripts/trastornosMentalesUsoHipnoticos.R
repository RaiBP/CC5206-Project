...
ggplot(d, aes(x = Fecha))+ 
  ...
  ggtitle("Incidencia de trastorno mental y del comportamiento debido al uso de sedantes o hipnóticos en Quintero, Puchuncaví y a nivel nacional (sin contar Quintero ni Puchuncaví)")+
